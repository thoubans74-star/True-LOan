...
class HomeLoanBottomCard extends StatelessWidget {
  const HomeLoanBottomCard({super.key});
...
// ── Home Loan Bottom Sheet ──────────────────────────────────────────────────
void showHomeLoanBottomSheet(BuildContext context) {
  showModalBottomSheet(
    ...
    builder: (context) => const HomeLoanBottomSheet(),
  );
}

class HomeLoanBottomSheet extends StatelessWidget {
  const HomeLoanBottomSheet({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
                    ...
                    children: [
                      Image.asset(
                        ...
                        errorBuilder: (context, error, stackTrace) =>
                            Icon(Icons.home, size: 48.w, color: Color(0xFF061A5C)),
                      ),
                      SizedBox(width: 12.w),
                      Expanded(
                        child: Column(
          ...
          // Fixed bottom section: Apply Now + Footer
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFeatureItem(
            'Tax Benefits',
            'Deductions under Sec 80C & 24b.',
          ),
          SizedBox(height: 14.h),
          _buildFeatureItem(
            'Zero Prepayment',
            'No charges for part payments.',
          ),
          SizedBox(height: 14.h),
          _buildFeatureItem(
            'Overdraft Facility',
            'Save interest on surplus funds.',
          ),
        ],
      ),
    );
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: Icon(Icons.check, color: Color(0xFF03C68A), size: 14.w),
        ),
        SizedBox(width: 12.w),
        Expanded(
          child: Column(
